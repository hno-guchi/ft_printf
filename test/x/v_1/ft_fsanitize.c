...
ft_printf("\n[01]------- (%%x); x = 4294967295 ----------\n");
	...
	ft_printf("\n[08]------- (%%.0x); x = 4294967295 ----------\n");
	ft_printf("=> [%d]\n", ft_printf("[%.0x] |", 4294967295));
	ft_printf("\n[09]------- (%%10.0x); x = 4294967295 ----------\n");
	ft_printf("=> [%d]\n", ft_printf("[%10.0x] |", 4294967295));
	ft_printf("\n[10]------- (%%11.0x); x = 4294967295 ----------\n");
	ft_printf("=> [%d]\n", ft_printf("[%11.0x] |", 4294967295));
	ft_printf("\n[11]------- (%%12.0x); x = 4294967295 ----------\n");
	ft_printf("=> [%d]\n", ft_printf("[%12.0x] |", 4294967295));
	ft_printf("\n[12]------- (%%13.0x); x = 4294967295 ----------\n");
	ft_printf("=> [%d]\n", ft_printf("[%13.0x] |", 4294967295));
	ft_printf("\n[13]------- (%%10.0x); x = 4294967295 ----------\n");
	ft_printf("=> [%d]\n", ft_printf("[%14.0x] |", 4294967295));
*/
