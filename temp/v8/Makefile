...
SRCS = ft_printf.c \
	...
	ftp_slt_conv.c \
	ftp_conv_c.c ftp_conv_percent.c ftp_conv_s.c ftp_conv_d_i.c ftp_conv_u.c ftp_conv_p.c ftp_conv_x.c \
	ftp_check_len_cnt.c \
	ftp_puts_c_s.c ftp_puts_d_i.c ftp_puts_u.c ftp_puts_p.c ftp_fputs_x.c \
	ftp_put_flags_plus_space.c ftp_put_flag_sharp.c ftp_puts_character.c \
